  ...
  def testGenerateIfConfirmed(self):
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
      ...
      expected = 'Do you want to Generate the files?'+\
        'create ' + tmpdir + '\\plaso\\formatters\\the_plugin.py' + \
        'create ' + tmpdir + '\\plaso\parsers\sqlite_plugins\\the_plugin.py' + \
        'create ' + tmpdir + '\\tests\\formatters\\the_plugin.py' + \
        'create ' + tmpdir + '\\tests\parsers\sqlite_plugins\\the_plugin.py' + \
        'copy ' + tmpdir + '\\test_data\\the_plugin.' + \
        'create ' + tmpdir + '\\plaso\parsers\sqlite_plugins\__init__.py' + \
        'create ' + tmpdir + '\\plaso\\formatters\__init__.py'
