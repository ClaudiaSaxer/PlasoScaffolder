...
class SQLiteQueryExecutionTest(unittest.TestCase):
  ...
  def testExecuteQuerySimple(self):
    ...
    result = self.execute.executeQuery(query)
    expected_data = [(
      1177252957.0, 1449070544.333328, 'BBCBreaking',
      'BBC Breaking News',
      ...
      245), (1235576198.0, 1449070777.5616121, 'SANSInstitute',
             'SANS Institute',
             'https://pbs.twimg.com/profile_images/591241253574070274'
             '/d8f5Oa1o_normal.png',
             'Worldwide',
  ...
  def testExecuteQueryWithJoin(self):
    ...
    result = self.execute.executeQuery(query)
    expected_data = [
      (1410435976.0, 'Never forget. http://t.co/L7bjWue1A2',
       ...
       22280436, 'SANS DFIR', 13, 6, 0, 1449070777.569118), (
        ...
        1449070777.573579), (1447766806.0,
                             ...
                             1449070777.573422), (1447766816.0,
                                                  'RT '
                                                  '@sansforensics: Call for '
                                                  'papers is now open for '
                                                  '#DFIRSummit 2016. Submit '
                                                  'by Dec18. More info here: '
                                                  'https://t.co/W4Ks4ylebI  '
                                                  '#DFIR https:…',
                                                  475222380,
                                                  'Heather '
                                                  'Mahalik',
      ...
      (1447888301.0,
       ...
       1449070777.575239), (1447964533.0,
                            ...
                            0, 1449070777.574604), (1447966303.0,
                                                    'RT '
                                                    '@jtrajewski: If anyone '
                                                    'is interested in jumping '
                                                    'to academia to teach '
                                                    '#dfir send me a message. '
                                                    'We may have an '
                                                    'opportunity for a '
                                                    'full-time…',
                                                    475222380,
      ...
      (
        ...
        1449070463.645055), (1448983988.0,
                             ...
                             1449070777.56599), (1448984000.0,
                                                 'RT '
                                                 '@sansforensics: Still time '
                                                 'to register #FOR572 with '
                                                 '@philhagen @ #SANSCDI to '
                                                 'incorporate '
                                                 '#networkforensics into your '
                                                 'investigations http…',
                                                 475222380,
                                                 'Heather '
                                                 'Mahalik',
